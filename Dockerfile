...
# ==============================================================================
# xl-sandboxed-opencode - Hardened Dockerfile
...
COPY --chown=agent scripts/quickstart.py /home/agent/app/quickstart.py
COPY --chown=agent scripts/harness_mcp.py /home/agent/app/harness_mcp.py
